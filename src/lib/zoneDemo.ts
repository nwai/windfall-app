...
console.log('-'.repeat(60));
console.log('1. For TTP (Temperature Transition Diagnostics):');
console.log('   - Multiply transition diagnostic scores by number weights');
console.log('   - Numbers in trending zones get higher diagnostic scores');
console.log();
