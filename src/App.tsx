                  ...
                  <tr key={n}>
                    ...
                    >
                      <label
                        ...
                        title={isUserExcluded ? `Number ${n} is excluded by User Exclusions. Clear it in WFMQYH User Exclusions before selecting it here.` : checked ? `Remove ${n} from user-selected numbers` : `Add ${n} to user-selected numbers`}
                      >
                        <input
                          type="checkbox"
                          checked={checked}
